...
define('todos/templates/todos', ['exports', 'ember'], function (exports, Ember) {
  ...
  function program3(depth0,data) {
    ...
    stack1 = helpers['if'].call(depth0, "hasCompleted", {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(3, program3, data),contexts:[depth0],types:["ID"],data:data});
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n  </footer>\n</section>\n");
    return buffer;
